 ...
 * @author LappoPolina
 * 
 * Класс содержит сведения о продаже: уникальный номер, сведения о клиенте, сведения о покупаемых устройствах и их количество
 * Так же имеются свойства для получения и изменения отдельных полей класса
 * Переопределен метод toString() для того, что бы собирать данные о продаже в одну строку,
...
public class Sale {
	...
	/**
	 * Переопределяемый метод для вывода информации о продаже
	 * Все данные о продаже собирает в одну строку
	 * @return String 
	 */
	@Override
